...
struct PyCallBack_exception : public std::exception {
...
{
	{ // std::exception file:exception line:97
		pybind11::class_<std::exception, std::shared_ptr<std::exception>, PyCallBack_exception> cl(M("std"), "exception", "");
		pybind11::handle cl_type = cl;

		cl.def( pybind11::init( [](){ return new PyCallBack_exception(); } ) );
		cl.def(pybind11::init<PyCallBack_exception const &>());
