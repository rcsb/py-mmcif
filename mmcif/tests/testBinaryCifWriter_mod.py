...
class BinaryCifWriterTests(unittest.TestCase):
    def setUp(self):
        ...
        #
        self.__pathTextCif = os.path.join(HERE, "data", "AF_AFP00000F1.cif")
        self.__testBcifOutput = os.path.join(self.__pathOutputDir, "AF_AFP00000F1-generated.bcif")
        self.__testBcifTranslated = os.path.join(self.__pathOutputDir, "AF_AFP00000F1-generated-translated.bcif")
        self.__pathPdbxDictionary = os.path.join(HERE, "data", "rcsb_mmcif_all.dic")
