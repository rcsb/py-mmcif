...
class DataCategoryTyped(DataCategory):
    ...
    def applyTypes(self, ignoreCastErrors=False, useCifUnknowns=True, missingValueString=None, missingValueInteger=None, missingValueFloat=None):
        ...
        try:
            for ii, atName in enumerate(self.getAttributeList()):
                ...
                # if self.getName() == "em_single_particle_entity":
                #     logger.info("1 em_single_particle_entity attribute %r dataType: %r", atName, dataType)
                if not dataType:
    ...
    def __getAttributeInfo(self, atName):
        ...
        # logger.info("cat %r, attribute %r cifDataType: %r, cifPrimitiveType %r", self.getName(), atName, cifDataType, cifPrimitiveType)
        ...
        if cifDataType is None:
            ...
            # if self.getName() == "em_single_particle_entity":
            #     logger.info("em_single_particle_entity attribute %r dataType: %r", atName, dataType)
